  ...
  NodeTpl.prototype._initTpls = function() {
    ...
    this.tpls = {
      "main": function($DATA, guid) {
        ...
        _ += '<style>#' + guid + ' .content-title {  background-color: #daedf5;  border-bottom: 1px solid #aed1eb;  line-height: 30px;  padding: 0 1em;}#' + guid + ' .planting-tree {  width: 120px;}#' + guid + ' .planting-tree ul {  list-style: none;  padding: 0;  margin: 0;}#' + guid + ' .planting-tree ul li {  padding: 0;  margin: 5px 0;}#' + guid + ' .planting-tree ul li a {  display: block;  color: #333;  line-height: 30px;  padding-left: 20px;  text-decoration: none;  position: relative;}#' + guid + ' .planting-tree ul li a .fa {  vertical-align: middle;  margin-right: 5px;}#' + guid + ' .planting-tree ul li.active a,.planting-tree ul li a:hover {  background-color: #eaf2ff;}#' + guid + ' .planting-tree ul li.active a:after {  position: absolute;  content: "";  display: block;  border: 5px solid transparent;  width: 0;  height: 0;  overflow: hidden;  border-left-color: #333;  right: 0;  top: 10px;}#' + guid + ' .planting-details {  padding: 5px;}</style>';
        try {
